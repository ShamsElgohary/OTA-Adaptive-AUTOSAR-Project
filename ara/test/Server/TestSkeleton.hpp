    ...
    namespace ucm
    {
        namespace pkgmgr
        {
            ...
            public:
                ...
                PackageManagerSkeleton(ara::com::InstanceIdentifier I_id, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent) : skeletonBase("/home/loay/Documents/GitHub/OTA-Adaptive-AUTOSAR-Project/executables/com_skeleton_test/etc/service_manifest.json",1, I_id, mode)
                {
                }
            };
        }
