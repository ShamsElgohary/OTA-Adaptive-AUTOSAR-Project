        ...
        namespace pkgmgr
        {
            namespace proxy
            {
                ...
                public:
                    ...
                    {
                        return ara::com::proxy::ProxyBase::FindService(CUSTOMIZED_PROJECT_PATH + "/executables/com_proxy_test/etc/service_manifest.json",1);
                    }
                    static ara::com::ServiceHandleContainer<ProxyBase::HandleType> FindService(ara::com::InstanceIdentifier InstanceID)
                    {
                        return ara::com::proxy::ProxyBase::FindService(CUSTOMIZED_PROJECT_PATH + "/executables/com_proxy_test/etc/service_manifest.json",1, InstanceID);
                    }
                    methods::Add Add;
                };
            }
