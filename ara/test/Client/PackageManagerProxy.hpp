        ...
        namespace pkgmgr
        {
            namespace proxy
            {
                ...
                public:
                    ...
                    {
                        return ara::com::proxy::ProxyBase::FindService(CUSTOMIZED_PROJECT_PATH + "executables/com_proxy_test/0.1/etc/service_manifest.json", Cluster_Name, 2);
                    }
                    static ara::com::ServiceHandleContainer<ProxyBase::HandleType> FindService(ara::com::InstanceIdentifier InstanceID)
                    {
                        return ara::com::proxy::ProxyBase::FindService(CUSTOMIZED_PROJECT_PATH + "executables/com_proxy_test/0.1/etc/service_manifest.json", Cluster_Name, 2, InstanceID);
                    }
