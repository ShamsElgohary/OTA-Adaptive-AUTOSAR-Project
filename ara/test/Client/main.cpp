...
int main()
{
    ...
    if (handles.size())
    {
        ...
        ifstream ifs("/home/yasmin/Desktop/Graduation_Project/02-OurImpement/OTA-Adaptive-AUTOSAR-Project/executables/com_proxy_test/bin/PackageTest.zip", ios::binary | ios::ate);
