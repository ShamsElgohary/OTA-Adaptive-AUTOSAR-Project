        ...
        namespace UpdateRequest
        {
            namespace proxy
            {
                ...
                public:
                    ...
                    {
                        return ara::com::proxy::ProxyBase::FindService("/home/kareem/Documents/GitHub/OTA-Adaptive-AUTOSAR-Project/executables/ucm/etc/service_manifest.json", Cluster_Name, 1);
                    }
                    static ara::com::ServiceHandleContainer<ProxyBase::HandleType> FindService(ara::com::InstanceIdentifier InstanceID)
                    {
                        return ara::com::proxy::ProxyBase::FindService("/home/kareem/Documents/GitHub/OTA-Adaptive-AUTOSAR-Project/executables/ucm/etc/service_manifest.json", Cluster_Name, 1, InstanceID);
                    }
