...
namespace ara
{
    namespace sm
    {
        namespace skeleton
        {
            ...
            {
            public:
               UpdateRequestSkeleton(ara::com::InstanceIdentifier I_id, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent) : skeletonBase("/home/tabakh/Desktop/GP/src/OTA-Adaptive-AUTOSAR-Project//executables/sm/etc/service_manifest.json",1 , I_id, mode)
               {
               }
                /** StartUpdateSession **/
